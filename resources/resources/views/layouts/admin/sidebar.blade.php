		...
		<nav class="sidebar-main">
			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName() == 'careers' ? 'active' : ''}}" href="{{ url('careers') }}"><i class="icofont icofont-briefcase-alt-1"></i><span> Careers</span></a></li>
				</ul>
			</div>
