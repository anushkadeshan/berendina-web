<div class="wrapper">
    ...
    <nav id="sidebar">
        <ul class="list-unstyled components">
            ...
            <li class="{{$annual_reports ? 'active': ''}}" style="margin-bottom: 10px;background-color:#4f93ce">
                <a style="font-size: 16px; color:#fff" href="#" wire:click.prevent="loadAR">Annual Reports</a>
            </li>
            <li class="{{$press ? 'active': ''}}" style="margin-bottom: 10px; background-color:#4f93ce"">
                <a style="font-size: 16px; color:#fff" href="#" wire:click.prevent="loadPress">BDS Press Releases</a>
            </li>
