                    ...
                    <div class="row mb-8">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <select class="form-select digits" wire:model="category" id="exampleFormControlSelect9">
                    ...
                    <div class="row mb-8">
                        <div class="col">
                            <div wire:ignore class="mb-3">
                                ...
                                <div class="mb-3">
                                    <img class="img image-fluid" src="{{URL::asset('storage/photos/bds/thumb_small/'.$image)}}" alt="">
                                </div>
