        ...
        <div class="row mb-4">
            <div class="col">
                <div wire:ignore class="mb-3">
                    ...
                    <div id="job_description" class="border border-black" data-job_description="@this" wire:model="job_description">
                        <p>{{$job_description}}</p>
                    </div>
        ...
        <div class="row mb-4">
            <div class="col">
                <div wire:ignore class="mb-3">
                    ...
                    <div id="si_job_description" class="border border-black" data-si_job_description="@this" wire:model="si_job_description">
                        <p>{{$si_job_description}}</p>
                    </div>
                    @error('si_job_description') <span class="error text-danger">*{{ $message }}</span> @enderror
                </div>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col">
                <div wire:ignore class="mb-3">
                    ...
                    <div id="ta_job_description" class="border border-black" data-ta_job_description="@this" wire:model="ta_job_description">
                        <p>{{$ta_job_description}}</p>
                    </div>
                    @error('ta_job_description') <span class="error text-danger">*{{ $message }}</span> @enderror
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col">
                <div class="mb-3">
                    ...
                    <input class="form-control"  wire:model="closing_date" id="exampleFormControlInput1" type="date">
