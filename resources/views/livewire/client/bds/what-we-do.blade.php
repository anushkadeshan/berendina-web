        ...
        <ul class="list-unstyled components">
            ...
            <li style="margin-bottom: 10px;background-color:#4f93ce">
                ...
                <ul class="collapse {{$gender || $envirnment || $disability || $youth? 'show': ''}} list-unstyled" id="pageSubmenu2">
                    ...
                    <li class="{{$envirnment ? 'active': ''}}" style="margin-bottom: 10px; background-color:#4f93ce">
                        <a style="font-size: 16px; color:#fff" href="" wire:click.prevent="LoadEnvirnment">Environment Sustainability</a>
                    </li>
                    <li class="{{$disability ? 'active': ''}}" style="margin-bottom: 10px; background-color:#4f93ce">
                        <a style="font-size: 16px; color:#fff" href="" wire:click.prevent="LoadDisability">Disability Inclusion</a>
                    </li>
                    <li class="{{$youth ? 'active': ''}}" style="margin-bottom: 10px; background-color:#4f93ce">
                        <a style="font-size: 16px; color:#fff" href="" wire:click.prevent="LoadYouth">Ensuring youth engagement</a>
                    </li>
                </ul>
            </li>
            <li style="margin-bottom: 10px;background-color:#4f93ce">
