                ...
                <div id="myTabContent" class="tab-content fancyTabContent" aria-live="polite">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table class="responsive-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>To the existing small entrepreneurs for financing working capital requirement, expansion or diversification needs which could also create increased employment opportunities in the rural areas.</td>
                                            </tr>
                                    ...
                                    <ol>
                                        <li>1. <b>Clusters:</b> The main and the most popular channel is the cluster channel. A cluster is a group of 30 clients comprised of 10 small groups of 3 clients. Small group members guarantee the loan of other members. </li>
                                        <li>2. <b>Estate Workers Housing Cooperative Societies (EWHCS)</b> Loan requirements of Plantation sector employees are provided through the EWHCS where BMIC provides a bulk loan to Cooperative Society and it will lend to their employees. Recoveries are collected from worker’s payroll.</li>
                                        <li>3. <b>Individual Loan:</b> Loan is given to the client by obtaining the personal guarantees from acceptable external persons whom are not borrowers of BMIC but having regular and adequate income source.</li>
                                    </ol>
                                </div>
                    ...
                    <div class="tab-pane  fade" id="tabBody1" role="tabpanel" aria-labelledby="tab1" aria-hidden="true"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <p>BMIC is a unique organization that supports low income people by providing micro credit along with credit plus service known as Enterprise Development Services (EDS). BMIC is proud to be one of the handful of organizations which provide such services to the rural communities and it is known to be the only MFI that delivers a dedicated EDS component along with the credit facilities. BMIC has a dedicated team to provide EDS with following objectives:</p>
                                <ul class="list-icon theme-colored" style="font-size: 4px;">
                                    <li><i class="fa fa-arrow-right"></i>To enhance the performances of existing
                                        businesses </li>
                                    <li><i class="fa fa-arrow-right"></i>To increase new reasonably profitable and
                                        sustainable business opportunities</li>
                                    <li><i class="fa fa-arrow-right"></i>To increase employments generated by small
                                        businesses</li>
                                    <li><i class="fa fa-arrow-right"></i>To increase legal/ environmental compliances by
                                        business people</li>
                                    <li><i class="fa fa-arrow-right"></i>To increase business risk mitigating strategies
                                    </li>
                                    <li><i class="fa fa-arrow-right"></i>To increase the marketing opportunities </li>
                                    <li><i class="fa fa-arrow-right"></i>To create an enabling environment for
                                        businesses development </li>
                                    <li><i class="fa fa-arrow-right"></i>To increase the financial literacy of business
                                        people </li>
                                </ul>
                                
                                <p style="text-align: justify;" class="mt-20">
                                    EDS Coupons: In order to provide EDS training services in a financially sustainable manner, BMIC has evolved a creative demand driven system through which clients pay for the services. BMIC issues 'EDS coupons' together with the loans. The value of the coupon is paid to BMIC with the monthly loan instalment by clients. There is no interest charged for coupon value. Client or client’s family members can use those coupons to pay the fees for EDS services or alternatively the client can offset the money paid for the coupon for the last instalment of the loan repayment by returning coupons. Most of the Services other than training programs are provided for clients free of charge. This novel EDS coupon methodology is now replicated in Nepal by Nepal Women Community Service Center (NWCSC), Mahila Sahayatra Microfinance Bittiya Santha Ltd and Nerude Laghubitta Bittiya Sanstha Ltd.</p>
                                    {{--
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Agriculture and Livestock Technical Trainings <br>
                                                    ...
                                                    Exposure Visits <br>
                                                    Life Skills Development Trainings <br>
                                                    Enterprise Development Trainings<br>
                                            ...
                                            <tr>
                                                ...
                                                <td>To initiate the projects, increase the income of individual or group of people by using new product for the areas, new or existing technology, or new market and or using untapped resources while drawing ten or more business opportunities or employment opportunities for local individuals</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>To create and improve market linkages with existing and new market channels and provide opportunity to market their products and services</td>
                                                <td>District level market and supply linkages<br>
                                                    National level market and supply linkage<br>
                                                    Provide ekade.lk ecommerce platform to market their product <br>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">E Type = Environment safeguard programme</th>
                                                <td>To safeguard the environment including identification of enterprises of BMIC cliental who generates adverse environmental impacts and implement mitigating measures to minimize those adverse impacts.</td>
                                ...
                                <table class="responsive-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>5% Per Annum (Annual Effective Rate -  5.12%)</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
