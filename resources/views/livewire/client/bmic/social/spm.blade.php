<div class="container">
    ...
    <p>Poverty outreach of BMIC clients in 2020 is depicted below.</p>
    <img src="{{asset('images/outreach 2.svg')}}" alt="Poverty Focused Approach" class="img img-thumb img-responsive"
        height="300px">
    <h4 class="line-bottom mt-40">2. Customer Centric Products and Services</h4>
    ...
    <h4 class="line-bottom mt-40">3. Obtaining and Use of Client feedback</h4>
    <p class="text-justify mt-20" style="text-align: justify;">
    ...
    <h4 class="line-bottom mt-40">4. Client Protection</h4>
    <p class="text-justify mt-20" style="text-align: justify;">
    <h5><b>Client privacy</b></h5>
    ...
    <h5><b>Client Grievance handling mechanism</b></h5>
    ...
    <p class="text-justify mt-20" style="text-align: justify;">
        ...
        <br>
        <br>
        <b>BMIC is an endorsee to the Smart Campaign since 2018</b>
    </p>
</div>
